...
os.chdir("/home/user/Documents/Official/Courses/krylov/non_hermitian_MBL/with_TRS/L14")
...
h_list = [3,4,5,6,6.5,6.75,7,7.25,7.5,8,8.5,9,10]



for h in h_list:
    
    folder_name = f'sing_g_{g}_h_{h}_L_{L}_R_{realizations}'
    ...
    for r in range(realizations):
        ...
        np.savetxt(f'sing_g_{g}_h_{h}_L_{L}_R_{realizations}/SingVal_set_{r}.txt',SingVal)
        np.savetxt(f'sing_g_{g}_h_{h}_L_{L}_R_{realizations}/EigVal_set_{r}.txt',E)
...
'''
        ...
        np.savetxt(f'sing_g_{g}_h_{h}_L_{L}_R_{realizations}/an_List_Ar_set_{r}.txt',an_List_Ar)
        np.savetxt(f'sing_g_{g}_h_{h}_L_{L}_R_{realizations}/bn_List_Ar_set_{r}.txt',bn_List_Ar)
        #
        #
        ...
        np.savetxt(f'sing_g_{g}_h_{h}_L_{L}_R_{realizations}/an_List_Bi_set_{r}.txt',an_list)
        np.savetxt(f'sing_g_{g}_h_{h}_L_{L}_R_{realizations}/cn_List_Bi_set_{r}.txt',cn_list)
