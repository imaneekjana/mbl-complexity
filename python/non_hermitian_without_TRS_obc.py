...
os.chdir("/home/user/Documents/Official/Courses/krylov/non_hermitian_MBL/without_TRS_obc/L12")
...
def create_ham(hi):
    ...
    term1 = [[-J*np.exp(g),i,(i+1)%L] for i in range(L-1)] #OBC

    term2 = [[-J*np.exp(-g),i,(i+1)%L] for i in range(L-1)] #OBC

    term3 = [[U,i,(i+1)%L] for i in range(L-1)] #OPBC


    term4 = [[random[i]-1j*gamma*(-1)**i,i] for i in range(L)] # oBC
...
for h in h_list:
    ...
    tf = 10*dim
    dt = 0.001*dim
    tListEarly = np.arange(0,4*dt,4*dt/2000)
    ...
    os.makedirs('gamma_pt1_h_{}_R_150_obc'.format(h))

    np.savetxt("gamma_pt1_h_{}_R_150/complexity_Bi_av_J_{}_U_{}_gamma_{}_h_{}_R_{}_obc.txt".format(h,J,U,gamma,h,realizations),complexity_Bi_av)
    np.savetxt("gamma_pt1_h_{}_R_150/KIPR_Bi_av_J_{}_U_{}_gamma_{}_h_{}_R_{}_obc.txt".format(h,J,U,gamma,h,realizations),KIPR_Bi_av)
    np.savetxt("gamma_pt1_h_{}_R_150/Kent_Bi_av_J_{}_U_{}_gamma_{}_h_{}_R_{}_obc.txt".format(h,J,U,gamma,h,realizations),Kent_Bi_av)
    np.savetxt("gamma_pt1_h_{}_R_150/complexity_Ar_av_J_{}_U_{}_gamma_{}_h_{}_R_{}_obc.txt".format(h,J,U,gamma,h,realizations),complexity_Ar_av)
    np.savetxt("gamma_pt1_h_{}_R_150/KIPR_Ar_av_J_{}_U_{}_gamma_{}_h_{}_R_{}_obc.txt".format(h,J,U,gamma,h,realizations),KIPR_Ar_av)
    np.savetxt("gamma_pt1_h_{}_R_150/Kent_Ar_av_J_{}_U_{}_gamma_{}_h_{}_R_{}_obc.txt".format(h,J,U,gamma,h,realizations),Kent_Ar_av)
    np.savetxt("gamma_pt1_h_{}_R_150/tListComp_J_{}_U_{}_gamma_{}_h_{}_R_{}_obc.txt".format(h,J,U,gamma,h,realizations),tListComp)
