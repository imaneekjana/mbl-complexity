...
def realization(w):
    ...
    return E_full,r_tilde_p,anlist,bnlist,np.array(complexity_list)/dim,t_list /dim  
...
'''plt.figure()
plt.scatter(n_list,anlist)  
plt.title('an_list')
plt.show()'''
#plt.savefig("/home/maitri/kry/an.pdf")

'''plt.figure()
plt.scatter(n_list,bnlist)  
plt.title('bn_list')
plt.show()'''
#plt.savefig("/home/maitri/kry/bn.pdf")
