...
os.chdir("/home/user/Documents/Official/Courses/krylov/non_hermitian_MBL/with_TRS/L12")
...
def create_ham(hi):
    ...
    term4 = [[random[i],i] for i in range(L)] # PBC
...
tf = 1.0*dim
dt = 0.005*dim
tListEarly = np.arange(0,4*dt,4*dt/100)
...
for r in range(realizations):
    ...
    #np.savetxt("g_pt1_h_2_R_150/singular_val/Singular_val_set_{}_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(r,J,U,g,h,realizations),SingVal)
    ...
    #np.savetxt("g_pt1_h_2_R_150/singular_val/an_List_Ar_set_{}_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(r,J,U,g,h,realizations),an_List_Ar)
    #np.savetxt("g_pt1_h_2_R_150/singular_val/bn_List_Ar_set_{}_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(r,J,U,g,h,realizations),bn_List_Ar)
    #
    #
    ...
    #np.savetxt("g_pt1_h_2_R_150/singular_val/cn_List_Bi_set_{}_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(r,J,U,g,h,realizations),cn_list)
    #
...
np.savetxt("g_pt1_h_3_R_150/complexity_Bi_av_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(J,U,g,h,realizations),complexity_Bi_av)
np.savetxt("g_pt1_h_3_R_150/KIPR_Bi_av_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(J,U,g,h,realizations),KIPR_Bi_av)
np.savetxt("g_pt1_h_3_R_150/Kent_Bi_av_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(J,U,g,h,realizations),Kent_Bi_av)
np.savetxt("g_pt1_h_3_R_150/complexity_Ar_av_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(J,U,g,h,realizations),complexity_Ar_av)
np.savetxt("g_pt1_h_3_R_150/KIPR_Ar_av_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(J,U,g,h,realizations),KIPR_Ar_av)
np.savetxt("g_pt1_h_3_R_150/Kent_Ar_av_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(J,U,g,h,realizations),Kent_Ar_av)
np.savetxt("g_pt1_h_3_R_150/tListComp_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(J,U,g,h,realizations),tListComp)
#np.savetxt("g_pt1_h_2_R_150/SuFF_av_J_{}_U_{}_g_{}_h_{}_R_{}.txt".format(J,U,g,h,realizations),SuFF_av)
